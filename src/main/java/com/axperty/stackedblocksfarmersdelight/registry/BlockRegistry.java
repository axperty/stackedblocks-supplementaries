...
public class BlockRegistry {
    public static final DeferredRegister.Blocks BLOCKS = DeferredRegister.createBlocks(StackedBlocksFarmersDelight.MOD_ID);

    // Stacked Rich Soil
    public static final DeferredBlock<Block> STACKED_RICH_SOIL = BLOCKS.registerSimpleBlock("stacked_rich_soil",
