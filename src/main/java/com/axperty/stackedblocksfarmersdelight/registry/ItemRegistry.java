...
public class ItemRegistry {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(StackedBlocksFarmersDelight.MOD_ID);

    // Stacked Rich Soil Item
    public static final DeferredItem<BlockItem> STACKED_RICH_SOIL_ITEM = ITEMS.registerSimpleBlockItem("stacked_rich_soil", BlockRegistry.STACKED_RICH_SOIL);
